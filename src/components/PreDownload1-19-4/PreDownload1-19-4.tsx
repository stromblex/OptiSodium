...
import styles from './PreDownload1-19-4.module.css';
...
const PreDownload1194 = () => {
  ...
  const handleContinue = () => {
    ...
    navigate(`/download-1-19-4?mods=${selectedModIds.join(',')}`);
  };
        ...
        <section className={styles.header}>
          ...
          <div className={styles.description}>
            <h1 className={styles.title}>
              Настройте ваш OptiSodium модпак для Minecraft 1.19.4
            </h1>
...
export default PreDownload1194;
