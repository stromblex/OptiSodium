...
import styles from './PreDownload1-20.module.css';
...
const PreDownload120 = () => {
  ...
  const handleContinue = () => {
    ...
    navigate(`/download-1-20?mods=${selectedModIds.join(',')}`);
  };
      ...
      <main className={styles.mainContent}>
        ...
        <section className={styles.header}>
          ...
          <div className={styles.description}>
            <h1 className={styles.title}>
              Настройте ваш OptiSodium модпак для Minecraft 1.20
            </h1>
        ...
        <section className={styles.modsSection}>
          ...
          <div className={styles.additionalInfo}>
            ...
            <a 
              href="https://modrinth.com/mods?f=categories:decoration&g=categories:fabric&v=1.20" 
              target="_blank" 
              rel="noopener noreferrer"
