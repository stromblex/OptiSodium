...
import styles from './PreDownload1-19.module.css';
...
const PreDownload1191 = () => {
  ...
  const handleContinue = () => {
    ...
    navigate(`/download-1-19?mods=${selectedModIds.join(',')}`);
  };
      ...
      <main className={styles.mainContent}>
        ...
        <section className={styles.header}>
          ...
          <div className={styles.description}>
            <h1 className={styles.title}>
              Настройте ваш OptiSodium модпак для Minecraft 1.19
            </h1>
        ...
        <section className={styles.modsSection}>
          ...
          <div className={styles.additionalInfo}>
            ...
            <a 
              href="https://modrinth.com/mods?f=categories:decoration&v=1.19&g=categories:fabric" 
              target="_blank" 
              rel="noopener noreferrer"
