...
│       ├── Download1-19-4/     # Файлы модов для MC 1.19.4
│       └── Download1-20/       # Файлы модов для MC 1.20
...
│   │   ├── PreDownload1-19-4/  # Выбор модов для 1.19.4
│   │   ├── Download1-19-4/     # Скачивание модпака 1.19.4
│   │   ├── PreDownload1-20/    # Выбор модов для 1.20
│   │   ├── Download1-20/       # Скачивание модпака 1.20
...
- Поддержка версий 1.19, 1.19.1, 1.19.2, 1.19.3, 1.19.4, 1.20
...
| Версия | Статус | Количество модов | Размер модпака |
|--------|--------|------------------|----------------|
| 1.20 | ✅ Новейшая | 43 мода | ~13MB |
| 1.19.4 | ✅ Актуально | 45+ модов | ~15MB |
| 1.19.3 | ✅ Актуально | 42+ модов | ~14MB |
| 1.19.2 | ✅ Стабильно | 40+ модов | ~13MB |
| 1.19.1 | ✅ Стабильно | 38+ модов | ~12MB |
| 1.19 | ✅ Стабильно | 35+ модов | ~11MB |

## 🔄 Последние изменения

### v1.2.0 (Июль 2025)
#### ✨ Новое
- **🎮 Добавлена полная поддержка Minecraft 1.20**
  - Создан компонент `PreDownload1-20` с выбором из 43 модов (18 обязательных + 22 дополнительных)
  - Создан компонент `Download1-20` с системой скачивания модпака
  - Добавлена структура папок `/assets/Download1-20/files/` с 40 .jar файлами модов
  - Полная интеграция в пользовательский интерфейс и маршрутизацию

#### 🔧 Улучшения
- **🏗️ Расширена архитектура проекта**
  - Добавлены lazy-импорты и маршруты для версии 1.20 в `App.tsx`
  - Обновлена логика навигации на главной странице (`HomePage.tsx`) для поддержки версии 1.20
  - Добавлен прелоадинг компонентов `PreDownload1-20` и `Download1-20`

#### 📦 Моды для Minecraft 1.20
- **Обязательные моды (18)**: Sodium, Lithium, Starlight, Fabric API, FerriteCore, Enhanced Block Entities, EntityCulling, ImmediatelyFast, More Culling, Dynamic FPS, Language Reload, Main Menu Credits, Reese's Sodium Options, Sodium Extra, VMP, WI Zoom, YOSBR, Cloth Config API
- **Дополнительные моды (22)**: Iris Shaders, Animatica, BetterBeds, C2ME, Capes, CIT Resewn, Clumps, Debugify, ETF, Entity View Distance, Fabric Language Kotlin, FabricSkyboxes, FastLoad, FastQuit, Krypton, LambDynamicLights, LazyDFU, MixinTrace, Mod Menu, Smoke Suppression, EMF, FSB Interop
- **Конфигурации**: Оптимизированный `options.txt` и `config.zip` с настройками модов

#### 📊 Техническое
- Общий размер модпака: ~13MB (40 модов + конфигурации)
- Обновлена таблица поддерживаемых версий с актуальной информацией
- Добавлена система зависимостей между модами (например, Iris зависит от Sodium)

### v1.1.0 (Июль 2025)
#### ✨ Новое
- **🎮 Добавлена поддержка Minecraft 1.19.4**
  - Новые компоненты `PreDownload1194` и `Download1194`
  - Обновленный список модов с 45+ оптимизациями
  - Полная интеграция в пользовательский интерфейс

#### 🔧 Улучшения
- **🎨 Исправлена стрелка скролла на главной странице**
  - Устранен эффект "рывка" при загрузке страницы
  - Скрытие стрелки на мобильных устройствах (< 768px)
  - Улучшена плавность анимаций

#### 🏗️ Техническое
- Обновлена архитектура маршрутизации в `App.tsx`
- Добавлен прелоадинг компонентов для версии 1.19.4
- Создана структура папок `/assets/Download1-19-4/files/`
- Синхронизированы списки модов между компонентами

#### 🐛 Исправления
- Устранены ошибки TypeScript при импорте компонентов 1.19.4
- Исправлены пути к файлам модов в компоненте скачивания
- Улучшена стабильность позиционирования UI элементов

### v1.0.0 (Июнь 2025)
#### ✨ Основные обновления
- **📝 Полностью переписан README.md**
  - Подробное описание архитектуры и назначения проекта
  - Инструкции по установке и расширению функциональности
  - Техническая документация для разработчиков

- **🔄 Синхронизированы списки модов**
  - Обновлены моды для версий 1.19, 1.19.1, 1.19.2, 1.19.3
  - Исправлены дублирующиеся записи
  - Актуализированы описания и зависимости модов
