...
import styles from './PreDownload1-19-3.module.css';
...
const PreDownload1193 = () => {
  ...
  const handleContinue = () => {
    ...
    navigate(`/download-1-19-3?mods=${selectedModIds.join(',')}`);
  };
        ...
        <section className={styles.header}>
          ...
          <div className={styles.description}>
            <h1 className={styles.title}>
              Настройте ваш OptiSodium модпак для Minecraft 1.19.3
            </h1>
...
export default PreDownload1193;
