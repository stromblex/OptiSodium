...
import styles from './PreDownload1-19-2.module.css';
...
const PreDownload1192 = () => {
  ...
  const handleContinue = () => {
    ...
    navigate(`/download-1-19-2?mods=${selectedModIds.join(',')}`);
  };
        ...
        <section className={styles.header}>
          ...
          <div className={styles.description}>
            <h1 className={styles.title}>
              Настройте ваш OptiSodium модпак для Minecraft 1.19.2
            </h1>
...
export default PreDownload1192;
