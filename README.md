...
- **🎮 Добавлена поддержка Minecraft 1.20**
  - Новые компоненты `PreDownload120` и `Download120`
  - Обновленный список модов с 40+ оптимизациями для версии 1.20
  - Полная интеграция в пользовательский интерфейс и маршрутизацию

#### 🔧 Улучшения
- **🏗️ Расширена архитектура проекта**
  - Добавлены маршруты `/pre-download-1-20` и `/download-1-20`
  - Обновлена логика навигации на главной странице для поддержки версии 1.20
  - Создана структура папок `/assets/Download1-20/files/`

#### 📦 Техническое
- Добавлен прелоадинг компонентов для версии 1.20 в `App.tsx`
- Обновлена таблица поддерживаемых версий в документации
- Синхронизированы списки модов для оптимальной совместимости
