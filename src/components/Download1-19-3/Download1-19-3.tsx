...
import styles from './Download1-19-3.module.css';
...
const Download1193 = () => {
  ...
  // Все доступные моды (полный массив из PreDownload1-19-3)
  const allMods: Mod[] = [
    {
      id: 'cloth-config',
  ...
  const handleDownload = async () => {
    ...
    try {
      ...
      try {
        const optionsResponse = await fetch('/assets/Download1-19-3/files/options.txt');
      ...
      try {
        const configZipResponse = await fetch('/assets/Download1-19-3/files/config.zip');
      ...
      link.href = url;
      link.download = 'optisodium1-19-3.zip';
        ...
        <div className={styles.contentPanel}>
          ...
          <div className={styles.header}>
            <div className={styles.logo} onClick={handleLogoClick} style={{ cursor: 'pointer' }}>
              ...
              />
              <span className={styles.logoText}>OptiSodium 1.19.3</span>
            </div>
          </div>
            ...
            {!downloadComplete ? (
              <>
                <h2 className={styles.title}>
                  Выбрано {selectedMods.length} модов для Minecraft Java Edition 1.19.3
                </h2>
